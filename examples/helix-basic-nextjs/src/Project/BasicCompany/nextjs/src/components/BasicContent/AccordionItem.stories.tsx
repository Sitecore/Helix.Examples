...
import { LayoutServiceContext, SitecoreContext } from '@sitecore-jss/sitecore-jss-nextjs';
...
Editing.decorators = [(Story) =>
    <SitecoreContext componentFactory={(_componentName: string) => null} context={{ pageEditing: true }}>
        <Story />
    </SitecoreContext>
];
