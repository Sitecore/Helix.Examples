...
const withFields = (fields: { linkUrl: string | undefined, imageUrl: string | undefined, headline: string, text: string }): PromoCardProps => {
    return {
        fields: {
            Link: {
                value: {
...
AllFields.args = withFields({
    ...
    text: '<p>Officia <em>consequat</em> adipisicing in magna dolore deserunt consequat consequat ex irure.</p>'
});
...
MissingLink.args = withFields({
    ...
    text: '<p>Lorem adipisicing qui <strong>minim</strong> est dolore cupidatat occaecat fugiat sunt.</p>'
});