...
Copy-Item -Path ("C:\tools\entrypoints\iis\*.config") -Destination "C:\inetpub\wwwroot\App_Config\Include"
...
& "C:\tools\bin\filebeat\filebeat.exe" -c ("C:\tools\entrypoints\iis\filebeat.yml")